...
```bash
git remote add encore encore://building-management-system-poc-cn6i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/building-management-system-poc-cn6i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/building-management-system-poc-cn6i/settings/integrations/github)
